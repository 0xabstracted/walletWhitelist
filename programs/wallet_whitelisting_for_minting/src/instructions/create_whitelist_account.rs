...
#[derive(Accounts)]
#[instruction( candy_machine_id: Pubkey, whitelisted_address: Pubkey, whitelist_type: String)]
...
pub fn handler(ctx: Context<CreateWhitelistAccount>, candy_machine_id: Pubkey, whitelisted_address: Pubkey, whitelist_type: String, number_of_whitelist_spots: u8 ) -> Result<()>{
    ...
    match whitelist_type.as_str() {
        "One" => wallet_whitelist_account.whitelist_type = WLType::One,
        "Two" => wallet_whitelist_account.whitelist_type = WLType::Two,
        "Three" => wallet_whitelist_account.whitelist_type = WLType::Three,
        "Four" => wallet_whitelist_account.whitelist_type = WLType::Four,
        _ => wallet_whitelist_account.whitelist_type = WLType::Null,
    }
